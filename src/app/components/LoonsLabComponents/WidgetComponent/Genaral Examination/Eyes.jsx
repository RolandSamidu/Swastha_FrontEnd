                ...
                <ValidatorForm onSubmit={() => { this.submit() }} className='flex mx-2' >
                    <Grid container spacing={1}>
                        ...
                        <Grid className='' item lg={12} md={12} sm={12} xs={12}>
                            <SubTitle title='Eyes' />
                            <RadioGroup defaultValue={this.state.formData.examination_data[0].other_answers.eyes} row>
                                <FormControlLabel
                                    label={"Normal"}
                                    name="normal"
                                    value="normal"
                                    onChange={() => {
                                        let formData = this.state.formData;
                                        formData.examination_data[0].other_answers.eyes = "normal"
                                ...
                                <FormControlLabel
                                    ...
                                    onChange={() => {
                                        let formData = this.state.formData;
                                        formData.examination_data[0].other_answers.eyes = "abnormal"
                                        this.setState({ formData })
                                    }}
                                    control={
                                        <Radio size='small' color="primary" />
                        ...
                        {/* If select Abnormal */}
                        { this.state.formData.examination_data[0].other_answers.eyes == 'abnormal' ?
                            <Grid className='' item lg={6} md={12} sm={12} xs={12}>
                                <SubTitle title='Icterus' />
                                <RadioGroup defaultValue={this.state.formData.examination_data[0].other_answers.icterus} row>
                                <FormControlLabel
                                    label={"No"}
                                    name="no"
                                    value="no"
                                    onChange={() => {
                                        let formData = this.state.formData;
                                        formData.examination_data[0].other_answers.icterus = "no"
                                        this.setState({ formData })
                                    }}
                                    control={
                                        <Radio size='small' color="primary" />
                                ...
                                <FormControlLabel
                                    ...
                                    onChange={() => {
                                        let formData = this.state.formData;
                                        formData.examination_data[0].other_answers.icterus = "yes"
                                        this.setState({ formData })
                                    }}
                                    control={
                                        <Radio size='small' color="primary" />
                        ...
                        { this.state.formData.examination_data[0].other_answers.eyes == 'abnormal' ?
                            <Grid className='' item lg={6} md={12} sm={12} xs={12}>
                                ...
                                <RadioGroup defaultValue={this.state.formData.examination_data[0].other_answers.pallore} row>
                                <FormControlLabel
                                    label={"No"}
                                    name="no"
                                    value="no"
                                    onChange={() => {
                                        let formData = this.state.formData;
                                        formData.examination_data[0].other_answers.pallore = "no"
                                        this.setState({ formData })
                                    }}
                                    control={
                                        <Radio size='small' color="primary" />
                                ...
                                <FormControlLabel
                                    ...
                                    onChange={() => {
                                        let formData = this.state.formData;
                                        formData.examination_data[0].other_answers.pallore = "yes"
                                        this.setState({ formData })
                                    }}
                                    control={
                                        <Radio size='small' color="primary" />
                        ...
                        {/* save */}
                        <Grid className='mt-2 flex justify-end' item lg={12} md={12} sm={12} xs={12}>
                            <Button
                                className='m-2' progress={false} type="submit" startIcon="save"
                            >
