                ...
                <ValidatorForm onSubmit={() => { this.submit() }} className='flex mx-2' >
                    <Grid container spacing={1}>
                        ...
                        <Grid className='' item lg={12} md={12} sm={12} xs={12}>
                            ...
                            <RadioGroup defaultValue={this.state.formData.examination_data[0].other_answers.neckRigidity} row>
                                <FormControlLabel
                                    label={"No"}
                                    name="no"
                                    value="no"
                                    onChange={() => {
                                        let formData = this.state.formData;
                                        formData.examination_data[0].other_answers.neckRigidity = "no"
                                ...
                                <FormControlLabel
                                    ...
                                    onChange={() => {
                                        let formData = this.state.formData;
                                        formData.examination_data[0].other_answers.neckRigidity = "present"
                                        this.setState({ formData })
                                    }}
                                    control={
                                        <Radio size='small' color="primary" />
                        ...
                        <Grid className='' item lg={12} md={12} sm={12} xs={12}>
                            ...
                            <RadioGroup defaultValue={this.state.formData.examination_data[0].other_answers.kernigsSign} row>
                                <FormControlLabel
                                    label={"No"}
                                    name="no"
                                    value="no"
                                    onChange={() => {
                                        let formData = this.state.formData;
                                        formData.examination_data[0].other_answers.kernigsSign = "no"
                                        this.setState({ formData })
                                    }}
                                    control={
                                        <Radio size='small' color="primary" />
                                ...
                                <FormControlLabel
                                    ...
                                    onChange={() => {
                                        let formData = this.state.formData;
                                        formData.examination_data[0].other_answers.kernigsSign = "present"
                                        this.setState({ formData })
                                    }}
                                    control={
                                        <Radio size='small' color="primary" />
                        ...
                        <Grid className='' item lg={12} md={12} sm={12} xs={12}>
                            ...
                            <RadioGroup defaultValue={this.state.formData.examination_data[0].other_answers.lymphadenopathy} row>
                                <FormControlLabel
                                    label={"No"}
                                    name="no"
                                    value="no"
                                    onChange={() => {
                                        let formData = this.state.formData;
                                        formData.examination_data[0].other_answers.lymphadenopathy = "no"
                                        this.setState({ formData })
                                    }}
                                    control={
                                        <Radio size='small' color="primary" />
                                ...
                                <FormControlLabel
                                    ...
                                    onChange={() => {
                                        let formData = this.state.formData;
                                        formData.examination_data[0].other_answers.lymphadenopathy = "present"
                                        this.setState({ formData })
                                    }}
                                    control={
                                        <Radio size='small' color="primary" />
                        ...
                        {this.state.formData.examination_data[0].other_answers.lymphadenopathy == 'present' ? 
                            <Grid className='' item lg={12} md={12} sm={12} xs={12}>
                                <SubTitle title='Left' />
