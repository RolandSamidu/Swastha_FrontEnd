...
class Involuntary_Movement extends Component {
    ...
    async loadData() {
        ...
        if (200 == res.status) {
            console.log("Examination Data Involuntary Movement", res.data.view.data)
            this.setState({ data: [] })
            let data = [];
            let other_answers = [];
                ...
                <ValidatorForm onSubmit={() => { this.submit() }} className='flex mx-2' >
                    <Grid container spacing={1}>
                        ...
                        <Grid className='' item lg={12} md={12} sm={12} xs={12}>
                            ...
                            <RadioGroup defaultValue={this.state.formData.examination_data[0].other_answers.involuntary_Movement} row>
                                <FormControlLabel
                                    label='No'
                                    name="no"
                                    value="no"
                                    onChange={() => {
                                        let formData = this.state.formData;
                                        formData.examination_data[0].other_answers.involuntary_Movement = "no"
                                ...
                                <FormControlLabel
                                    ...
                                    onChange={() => {
                                        let formData = this.state.formData;
                                        formData.examination_data[0].other_answers.involuntary_Movement = "present"
                                        this.setState({ formData })
                                    }}
                                    control={
                                        <Radio size='small' color="primary" />
                        ...
                        { this.state.formData.examination_data[0].other_answers.involuntary_Movement == 'present' ? 
                        <Grid className='' item lg={12} md={12} sm={12} xs={12}>
                            <SubTitle title='Tremors' />
                            <RadioGroup defaultValue={this.state.formData.examination_data[0].other_answers.tremors} row>
                                <FormControlLabel
                                    label='No'
                                    name="no"
                                    value="no"
                                    onChange={() => {
                                        let formData = this.state.formData;
                                        formData.examination_data[0].other_answers.tremors = "no"
                                        this.setState({ formData })
                                    }}
                                    control={
                                        <Radio size='small' color="primary" />
                                ...
                                <FormControlLabel
                                    ...
                                    onChange={() => {
                                        let formData = this.state.formData;
                                        formData.examination_data[0].other_answers.tremors = "fine"
                                        this.setState({ formData })
                                    }}
                                    control={
                                        <Radio size='small' color="primary" />
                                ...
                                <FormControlLabel
                                    ...
                                    onChange={() => {
                                        let formData = this.state.formData;
                                        formData.examination_data[0].other_answers.tremors = "coarse"
                                        this.setState({ formData })
                                    }}
                                    control={
                                        <Radio size='small' color="primary" />
