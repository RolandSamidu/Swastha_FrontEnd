                    ...
                    <Grid container spacing={1}>
                        ...
                        <Grid className='' item lg={6} md={6} sm={6} xs={6}>
                            ...
                            <TextValidator                                
                                ...
                                onChange={(e) => {
                                    let formData = this.state.formData;
                                        formData.examination_data[0].other_answers.celsius= e.target.value;
                                        formData.examination_data[0].other_answers.fahrenheit= Math.round(((parseFloat(formData.examination_data[0].other_answers.celsius) * 1.8 ) + 32)*10)/10 ;
                                        this.setState(
                                            {
                                                formData 
                                            }
                                ...
                                value={
                                    this.state.formData.examination_data[0].other_answers.celsius
                                }
                                InputProps={{
                                    endAdornment: (
                        ...
                        <Grid className='' item lg={6} md={6} sm={6} xs={6}>
                            ...
                            <TextValidator                                
                                ...
                                onChange={(e) => {
                                    let formData = this.state.formData
                                        formData.examination_data[0].other_answers.fahrenheit = e.target.value
                                        formData.examination_data[0].other_answers.celsius = Math.round(((parseFloat(formData.examination_data[0].other_answers.fahrenheit) - 32 ) / 1.8)*10)/10;
                                        this.setState(
                                            {
                                                formData 
                                            }
                                ...
                                value={
                                    this.state.formData.examination_data[0].other_answers.fahrenheit
                                }
                                InputProps={{
                                    endAdornment: (
                                        <InputAdornment position="end" >
