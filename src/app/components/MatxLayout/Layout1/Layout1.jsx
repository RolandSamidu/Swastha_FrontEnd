...
import { Button, useMediaQuery, IconButton, Icon, Tooltip } from '@material-ui/core'
...
const Layout1 = () => {
    ...
    return (
        <div className={clsx('bg-default', layoutClasses)}>
            <div id="app-fullscreen-1856" className='px-5 py-5'>
                ...
                {!settings.perfectScrollbar && (
                    <div className="flex-grow flex-column relative h-full scroll-y">
                        ...
                        <div id="home123" className="relative flex-grow">
                            ...
                            <Tooltip  className='show-on-appfullScreen'
                                style={{ position: 'absolute' }} title="Exit Fullscreen">
                                <IconButton
